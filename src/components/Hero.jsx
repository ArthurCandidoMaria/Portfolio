    ...
    >
      <motion.div
        ...
        style={{
          ...
          backgroundImage:
            "radial-gradient(circle at 50% 20%, rgba(56, 189, 248, 0.22), transparent 42%), radial-gradient(circle at 82% 86%, rgba(249, 115, 22, 0.14), transparent 40%), linear-gradient(180deg, rgba(31, 41, 51, 0.82) 0%, rgba(17, 24, 39, 0.9) 48%, rgba(10, 12, 15, 0.97) 100%), url('public/construction-site-new-modern-architecture-night.jpg')",
